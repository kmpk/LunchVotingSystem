...
class AdminMenuControllerTest extends AbstractControllerTest {
    ...
    void get() throws Exception {
        MenuTo returned = JsonUtil.readValue(perform(MockMvcRequestBuilders.get(REST_URL_SLASH + "/" + RESTAURANT_1_ID + "/menus/" + TODAY))
        ...
        returned = JsonUtil.readValue(perform(MockMvcRequestBuilders.get(REST_URL_SLASH + "/" + RESTAURANT_1_ID + "/menus/" + TODAY.minusDays(1)))
                .andExpect(status().isOk())
                .andDo(print())
                .andExpect(content().contentTypeCompatibleWith(MediaType.APPLICATION_JSON))
                .andReturn().getResponse().getContentAsString(), MenuTo.class);
    ...
    void getNotFound() throws Exception {
        perform(MockMvcRequestBuilders.get(REST_URL_SLASH + "/" + RESTAURANT_3_ID + "/menus/" + TODAY))
                .andDo(print())
                .andExpect(status().isNotFound());
        perform(MockMvcRequestBuilders.get(REST_URL_SLASH + "/" + RESTAURANT_1_ID + "/menus/" + TODAY.plusDays(1)))
                .andDo(print())
                .andExpect(status().isNotFound());
        perform(MockMvcRequestBuilders.get(REST_URL_SLASH + "/" + RESTAURANT_1_ID + "/menus/" + TODAY.minusDays(2)))
                .andDo(print())
                .andExpect(status().isNotFound());
    }
    ...
    void delete() throws Exception {
        perform(MockMvcRequestBuilders.delete(REST_URL_SLASH + "/" + RESTAURANT_1_ID + "/menus/" + TODAY))
                .andDo(print())
    ...
    void deleteNotFound() throws Exception {
        perform(MockMvcRequestBuilders.delete(REST_URL_SLASH + "/" + RESTAURANT_3_ID + "/menus/" + TODAY))
                .andDo(print())
                .andExpect(status().isUnprocessableEntity());
        perform(MockMvcRequestBuilders.delete(REST_URL_SLASH + "/" + RESTAURANT_1_ID + "/menus/" + TODAY.plusDays(1)))
                .andDo(print())
                .andExpect(status().isUnprocessableEntity());
        perform(MockMvcRequestBuilders.delete(REST_URL_SLASH + "/" + RESTAURANT_1_ID + "/menus/" + TODAY.minusDays(2)))
                .andDo(print())
                .andExpect(status().isUnprocessableEntity());
    }
    ...
    void getUnauthorized() throws Exception {
        perform(MockMvcRequestBuilders.get(REST_URL_SLASH + "/" + RESTAURANT_1_ID + "/menus/" + TODAY))
    ...
    void update() throws Exception {
        ...
        perform(MockMvcRequestBuilders.put(REST_URL_SLASH + "/" + RESTAURANT_1_ID + "/menus/" + TODAY)
    ...
    void updateNotFound() throws Exception {
        MenuTo updatedMenu = getUpdatedMenu();
        perform(MockMvcRequestBuilders.put(REST_URL_SLASH + "/" + NOT_FOUND + "/menus/" + TODAY)
                .contentType(MediaType.APPLICATION_JSON)
                .content(JsonUtil.writeValue(updatedMenu)))
                .andDo(print())
                .andExpect(status().isUnprocessableEntity());
